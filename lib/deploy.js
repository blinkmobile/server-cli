...
function deploy (
  ...
  serviceCliService.bucket = serviceCliService.bucket || values.SERVER_CLI_SERVICE_S3_BUCKET
  serviceCliService.origin = serviceCliService.origin || values.SERVER_CLI_SERVICE_ORIGIN
  ...
  return new Promise((resolve, reject) => {
    ...
    const baseRequest = request.defaults({
      ...
      baseUrl: `${serviceCliService.origin}/v1`,
      json: true
    })
    baseRequest.post('/deploy', {
      json: {
        bundleBucket: serviceCliService.bucket,
        bundleKey,
        env,
